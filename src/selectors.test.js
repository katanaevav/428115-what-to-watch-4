...
it(`getFilteredMovies should return all movies with filter All genres`, () => {
  expect(getFilteredMovies(allMovies, NO_FILTER)).toEqual(allMovies);
});

it(`getFilteredMovies should return drama movies with filter drama`, () => {
  expect(getFilteredMovies(allMovies, `Drama`)).toEqual(dramaMovies);
});
